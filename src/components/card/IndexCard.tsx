...
export default function IndexCard({ message } : { message: MessageType }) {
  ...
  return (
    <div className={styles['card-container']}>
      <Image src={cardDesign} alt='card' width={800} className={styles['card-bg-img']} />
      <div className={styles['card-front-container']}>
        <Image src={cardTitle} alt='title' width={600} className={styles['card-title-img']} />
        ...
        <div className={styles['card-message-area']}>
          <Image src={messageText} alt='message' width={80} className={styles['card-message-area-title-img']} />
        ...
        <div className={styles['card-member-area']}>
          <Image src={memberText} alt='message' width={80} className={styles['card-member-area-title-img']} />
          {message.memberName}
        </div>
      </div>
    </div>
